...
type BuildkitePipelineSpec struct {
	...
	// Foo is an example field of BuildkitePipeline. Edit buildkitepipeline_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// BuildkitePipelineStatus defines the observed state of BuildkitePipeline
...
type BuildkitePipeline struct {
	...
	Spec   BuildkitePipelineSpec   `json:"spec,omitempty"`
...
type BuildkitePipelineList struct {
	...
	Items           []BuildkitePipeline `json:"items"`
}

func init() {
	SchemeBuilder.Register(&BuildkitePipeline{}, &BuildkitePipelineList{})
}
